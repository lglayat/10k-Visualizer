...
histNote = Note.create({title: 'History Note', count: 1, doc: 'Marcus Aurelius assumed the throne according to a previously agreed upon succession, at a time of relative peace and prosperity for Rome. Though native to Rome, his family was of Iberian (Spanish) origin; Aurelius himself was a Stoic, and given to deep philosophical thought. With his rise to power, continued security for both the Roman state and society seemed likely. His entire rule, however, was occupied by challenges that would characterize Roman dilemmas for the next two-and-a-half centuries.
...
mathNote = Note.create({title: 'Math Note', count: 1, doc: 'This formula is sometimes called the power rule.  All we are doing here is bringing the original exponent down in front and multiplying and then subtracting one from the original exponent.
...
artNote = Note.create({title: 'Watercolor Basics', count: 1, doc: '1. USE A PORTABLE SET OF PAN PAINTS.
...
lawNote = Note.create({title: 'First Amendment',count: 1, doc: 'Congress shall make no law respecting an establishment of religion, or prohibiting the free exercise thereof; or abridging the freedom of speech, or of the press; or the right of the people peaceably to assemble, and to petition the Government for a redress of grievances.'})
financeNote = Note.create({title: 'What are ETFs',count: 1, doc: 'Exchange-traded funds are one of the most important and valuable products created for individual investors in recent years. ETFs offer many benefits and, if used wisely, are an excellent vehicle to achieve an investor’s investment goals.
...
engineeringNote = Note.create({title: 'Types of Cement',count: 1, doc: 'Characteristics
